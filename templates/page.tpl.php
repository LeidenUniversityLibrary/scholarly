...
<div id="page-wrapper"><div id="page">
    ...
    <main id="themain">
          ...
          <div class="dc-content" class="column"><div class="section">
              ...
              <?php $is_collection = (!empty($variables['node']) && ($variables['node']->type == 'collection' || $variables['node']->type == 'subcollection')) ? true : false; ?>
              <?php if ($title && !$is_collection): ?><h2 class="title" id="page-title"><?php print $title; ?></h2><?php endif; ?>
